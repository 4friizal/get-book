...
export default function CardProduct({
  ...
  return (
    <div>
      <div className="w-40 h-52 lg:w-56 lg:h-72 rounded-2xl border-2 border-[#D9D9D9]">
        <Link href={`/product/${encodeURIComponent(id)}`}>
          <a className="flex flex-col">
            ...
            <div className="w-full h-24 border-t-2 border-[#D9D9D9] p-2">
      ...
      {stock > 0 ? (
        <button
          type="button"
          className="my-2 w-40 lg:w-56 bg-[#25732D] text-white rounded-full flex items-center justify-center font-bold p-1"
        ...
        <button
          disabled
          type="button"
          className="my-2 w-40 lg:w-56 bg-[#D9D9D9] text-white dark:text-black rounded-full flex items-center justify-center font-bold p-1"
        >
